...
//   late Storage dataRepository;
//   late UsersService authApiService;
...
//     try {
//       bool isAuthenticated = 'false' == 'fl';
//       if (isAuthenticated) {
//         String? access = await dataRepository.getAccessToken();
//         List<Note?>? notes = await noteApiService.fetchNotes(accessToken: access);
...
//       );
//       if (isUpdated) {
//         bool isUpdatedLocal = await dataRepository.updateNote(index, noteFormData);
//         if (isUpdatedLocal) {
//           emit(const NotesStateLoading(mustRebuild: true));
//         } else {
...
//       if (isDeleted) {
//         bool isDeletedLocale = await dataRepository.deleteNote(index);
//         if (isDeletedLocale) {
//           emit(const NotesStateLoading(mustRebuild: true));
//         } else {
//           emit(
